...
8. Um einen Commit zu erstellen und den Prozess gleichzeitig genauer nachvollziehen zu können, wurde der Wert „test: ...” in der Datei 'database.yml' eingetragen. Auf dem Bare-Repository ist das Passwort mit dem Platzhalter „DB_PSW” in der Datei „database.yml” gespeichert. In Git-Repositories behält die Datei den echten Wert "supersecret123" auch nach der Ausführung von „push” und „pull”.
